...
/* External variables ---------------------------------------------------------*/
/* USER CODE BEGIN EV */
#define BUTTON_SW1_PIN GPIO_PIN_2
int Count = 0;
double temp=0;
float Amount = 0;
/* USER CODE END EV */
...
static void EXTI1_IRQHandler_Config(void)
{
  ...
  /* Configure PB.1 pin as input floating */
  GPIO_InitStructure.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStructure.Pull = GPIO_PULLUP;
  GPIO_InitStructure.Pin = BUTTON_SW1_PIN;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);

  /* Enable and set line 1 Interrupt to the lowest priority */
...

{
  /* Toggle LED2 */

		    {
		        ...
		        // Print debug message if you have a way to output messages
...
void SendTxData(void)
 {
    ...
    // uint32_t numericValue = 123456;
     ...
     if (LmHandlerIsBusy() == false)
     {
       ...
       // Set payload with the numeric value
//       AppData.Buffer[0] = (uint8_t)(Count & 0xFF);
//       AppData.Buffer[1] = (uint8_t)((Count >> 8) & 0xFF);
//       AppData.Buffer[2] = (uint8_t)((Count >> 16) & 0xFF);
//       AppData.Buffer[3] = (uint8_t)((Count >> 24) & 0xFF);
    	 uint32_t i = 0;
      ...
      // AppData.BufferSize = 4;  // Size of the payload is 4 bytes
