  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyCagK-Ic605WNx7aKLmD_jDbKljGxR-1n0",
        authDomain: "digital-water-billing-system.firebaseapp.com",
        projectId: "digital-water-billing-system",
        storageBucket: "digital-water-billing-system.appspot.com",
        messagingSenderId: "124422196270",
        appId: "1:124422196270:web:d301b9e641db4512eaa3bf",
        measurementId: "G-GGVE2PZEJL",
      ),
    );
  } else {
    if (Platform.isAndroid) {
      await Firebase.initializeApp(
        options: const FirebaseOptions(
          apiKey: 'AIzaSyAnMzNmXXEjmg7B6E_HjF0EaDicSpBbnIA',
          appId: '1:124422196270:android:0de180b99f5489d8eaa3bf',
          messagingSenderId: '124422196270',
          projectId: 'digital-water-billing-system',
          storageBucket: 'digital-water-billing-system.appspot.com',
        ),
